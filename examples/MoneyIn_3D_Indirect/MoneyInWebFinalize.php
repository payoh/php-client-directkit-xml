...
/**
 *		Case : This follows the MoneyInWebInit case : your customer has returned to your website or you have received a POST notification from Payoh. You now need to find out how the payment went.
 *		Steps :
 *			- GetMoneyInTransDetails
 *		Note :
 *			- In this example, we print data, but keep in mind that if you arrive here from the Payoh notification (with POST data), printing will be pointless. You can log data in a file instead.
 ...
 *				- just like Payoh, not change the payment status and still give your customer the opportunity to pay
 *				- decide to mark the payment as failed on your side, but keep in mind that this won't prevent Payoh from accepting the payment if the customer pays.
 */
